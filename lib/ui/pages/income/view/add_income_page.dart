...
class AddIncomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> addItem() async {
      isLoading = true;
      await DatabaseHelper.createItem(dateController.text, int.parse(amountController.text), captionController.text, 'income');
      await globalController.addBalance(int.parse(amountController.text));
      isLoading = false;
